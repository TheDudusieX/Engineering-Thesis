...
return array(
	...
	'distinct' 			   => ':attribute nie może występować więcej niż raz.',
	...
	*/
	...
	'attributes' => array(
		...
		'maximum_number_of_orchestras' => 'Limit zapisanych orkiestr',
		...
		'time' => [
			'0' => [
				'value' => 'Wybrana orkiestra w polu nr 1'
			],
			'1' => [
				'value' => 'Wybrana orkiestra w polu nr 2'
			],
			'2' => [
				'value' => 'Wybrana orkiestra w polu nr 3'
			],
			'3' => [
				'value' => 'Wybrana orkiestra w polu nr 4'
			],
			'4' => [
				'value' => 'Wybrana orkiestra w polu nr 5'
			],
			'5' => [
				'value' => 'Wybrana orkiestra w polu nr 6'
			],
			'6' => [
				'value' => 'Wybrana orkiestra w polu nr 7'
			],
			'7' => [
				'value' => 'Wybrana orkiestra w polu nr 8'
			],
			'8' => [
				'value' => 'Wybrana orkiestra w polu nr 9'
			],
			'9' => [
				'value' => 'Wybrana orkiestra w polu nr 10'
			],
			'10' => [
				'value' => 'Wybrana orkiestra w polu nr 11'
			],
			'11' => [
				'value' => 'Wybrana orkiestra w polu nr 12'
			],
			'12' => [
				'value' => 'Wybrana orkiestra w polu nr 13'
			],
			'13' => [
				'value' => 'Wybrana orkiestra w polu nr 14'
			],
			'14' => [
				'value' => 'Wybrana orkiestra w polu nr 15'
			],
			'15' => [
				'value' => 'Wybrana orkiestra w polu nr 16'
			],
		],
		'jury' => [
			'0' => [
				'value' => 'Juror wybrany w polu nr 1'
			],
			'1' => [
				'value' => 'Juror wybrany w polu nr 2'
			],
			'2' => [
				'value' => 'Juror wybrany w polu nr 3'
			],
		]

        //Dorzucić tłumaczenia
	),
