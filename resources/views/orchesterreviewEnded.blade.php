    ...
    <div class="container py-5">
        <div class="row text-center mb-4">
            <div class="col-lg-7 mx-auto">
                <h1>{{ __('translation.dashboard.endreview') }}</h1>
            </div>
        </div>
        ...
        <div class="container mt-5 mb-3 ">
            <div class="row review_container">
                <x-orchester-review-ended-component :review="$review"/>
            </div>
            <div class="d-flex justify-content-center">
                {!! $review->links() !!}
            </div>
    ...
    <script type="module">
        ...
        "firstDay": 1
            ...
            var dataTo = end.format('YYYY-MM-DD');
                ...
                $.ajax({ 
                url: '{{ route('dateFilterended') }}',
                type: 'POST',
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    data: { "dataFrom": dataFrom , "dataTo": dataTo, endedreview: true },
                },
